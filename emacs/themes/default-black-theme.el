;;; default-black-theme.el --- Emacs theme with a dark background.

;; Copyright (C) 2014 , burbma
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'default-black
        ...
        `(show-paren-match-face ((,class (:background ,"#0000ff"))))
        ...
        `(lazy-highlight ((,class (:foreground ,"#ffff00" :background ,bg3))))
